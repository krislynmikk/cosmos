         ...
         //   console.log("validCombinations", validCombinations);
           ...
           //     console.log("nextLegFlights", nextLegFlights);
            ...
            function findAndAddConsecutiveFlights(routeLegs, shortestRoutes) {
                ...
                shortestRoutes.forEach((shortestRouteIndex) => {
                    if (shortestRouteIndex >= routeLegs.length - 1) {
                        return; // Ensure the route index is within bounds
                    }
                    console.log("routelegssssss", routeLegs, "shortestrouteindex", shortestRouteIndex);
                    const currentLeg = routeLegs[shortestRouteIndex];
                    const nextLeg = routeLegs[shortestRouteIndex + 1];
                    console.log("CURRENTLEG", currentLeg);
                    console.log("NEXTLEG", currentLeg);
                    if (!currentLeg || !nextLeg) {
                        console.error("Current leg or next leg is missing.");
                        return;
                    }
                    ...
                    // Iterate through currentLeg and nextLeg flights
                    currentLeg.forEach(currentFlight => {
